...
# Form implementation generated from reading ui file 'scoop.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.resetButton = QtWidgets.QPushButton(Dialog,clicked= lambda:self.display("Reset"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.hargaVanilla.setText(_translate("Dialog", "2.10"))
        self.hargaStrawberry.setText(_translate("Dialog", "3.10"))
        self.hargaChocolate.setText(_translate("Dialog", "2.10"))
        self.hargasprinkle.setText(_translate("Dialog", "1.00"))
        self.hargaBoba.setText(_translate("Dialog", "2.00"))
        self.hargaChocChip.setText(_translate("Dialog", "1.00"))
        self.durian_lbl.setText(_translate("Dialog", "Durian"))
        self.cornlbl.setText(_translate("Dialog", "Corn"))
        self.hargaDurian.setText(_translate("Dialog", "5.10"))
        self.hargaCorn.setText(_translate("Dialog", "4.10"))
        self.calculateButton.clicked.connect(self.calculating)
        
    def display(self, pressed):
        if pressed == "Reset":
            self.total_textBox.setText("0") 
    ...
    def calculating(self):
        ...
        if self.boba.isChecked()==True:
            total=total + 2.1
        if self.cchip.isChecked()==True:
            total=total + 1
        if self.sprink.isChecked()==True:
            total=total + 1
