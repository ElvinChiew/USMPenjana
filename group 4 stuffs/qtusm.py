...
class Ui_GSTTaxCalculator(object):
 ...
 GSTTaxCalculator.resize(450, 286)
 ...
 self.results_output.setGeometry(QtCore.QRect(11, 202, 400,
33))
 font = QtGui.QFont()
 font.setPointSize(16)
...
QtWidgets.QPushButton(self.centralwidget)
 self.calculate_button.setGeometry(QtCore.QRect(11, 146, 115,
42))
 font = QtGui.QFont()
 font.setPointSize(16)
 ...
 GSTTaxCalculator.setWindowTitle(_translate("GSTTaxCalculator",
"MainWindow"))
 self.price.setText(_translate("GSTTaxCalculator", "Price"))
 self.tax_rate.setText(_translate("GSTTaxCalculator", "Tax
Rate"))
 self.title.setText(_translate("GSTTaxCalculator", "GST Tax
Calculator"))
 self.calculate_button.setText(_translate("GSTTaxCalculator",
"Calculate"))
 self.clear_button.setText(_translate("GSTTaxCalculator",
"Clear"))
...
# add below function to Class
 ...
 tax = Decimal(self.tax_rate_box.value())
